...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'service.station' => 'getService_StationService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'floor_plan', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5ddd95fe73620bd8c70750180eb85ff6bfca9985eff182682438533190424e38');
    ...
    /**
     * Gets the 'service.station' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\StationService A AppBundle\Service\StationService instance.
     */
    protected function getService_StationService()
    {
        return $this->services['service.station'] = new \AppBundle\Service\StationService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b09653e4ade27ed8a8a0024c1aecae0f1dacaad6');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55d20d00c96a83.84500418')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'b09653e4ade27ed8a8a0024c1aecae0f1dacaad6',
            'locale' => 'en',
            ...
            'kernel.secret' => 'b09653e4ade27ed8a8a0024c1aecae0f1dacaad6',
